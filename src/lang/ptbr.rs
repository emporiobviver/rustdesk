...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please wait for the remote side to accept your session request...", "Por favor, aguarde o lado remoto aceitar sua solicitação de sessão..."),
        ...
        ("Request access to your device", "Requisitar acesso ao seu dispositivo"),
    ].iter().cloned().collect();
}
